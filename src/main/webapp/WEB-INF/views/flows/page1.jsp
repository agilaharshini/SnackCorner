    ...
    myApp.factory('UserService', ['$http', '$q', function($http, $q)
                                  ...
                                  return {
                                      ...
                                      deleteFromCart: function(item){
                                              return $http.post('http://localhost:8080/snackcorner/flows/deleteFromCart/', item)
                                                      .then(
                                                              function(response){
                                              ...
                                              fetchAllItems: function(item){
                                                  return $http.post('http://localhost:8080/snackcorner/flows/fetchAllItems/')
                                                          .then(
                                                                  function(response){
                                                                      return response.data;
                                                                  }, 
...
<div class="col-sm-6">
 <div class="panel panel-primary" style="margin: auto; width: 85%;">
   ...
   <div class="panel-body" >
          		...
          		<img style="height:300; width:350;" src="${pageContext.request.contextPath}/{{x.ProductImage}}" width="100%" 
