package com.snackcorner;

import java.io.BufferedOutputStream;

import com.snackcorner.cartmodel.cart;
import com.snackcorner.cartmodel.cartservice;
import com.snackcorner.category.Category;
import java.io.File;
...
import com.snackcorner.category.CategoryService;
import com.snackcorner.product.Product;
import com.snackcorner.product.ProductService;
import com.snackcorner.user.User;
import com.snackcorner.user.UserService;
import com.snackcorner.userrole.Userrole;
import com.snackcorner.userrole.UserroleService;
...
public class SnackCornerController {
	...
	@RequestMapping("/icecake")
	public String hit23()
	{
		System.out.println("icecake");
		return("icecake");
	}


@RequestMapping("/marshmelo")
public String hit22()
{
	System.out.println("marshmelo");
	return("marshmelo");
}
...
@RequestMapping("/doublechip")
public String hit27()
{
	System.out.println("doublechip");
	return("doublechip");
}
	...
	public ModelAndView signup()
	{
		...
		System.out.println("hit control");		
